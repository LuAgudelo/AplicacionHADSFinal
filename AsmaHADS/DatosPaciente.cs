...
namespace AsmaHADS
{
    public partial class DatosPaciente : Form
    {
        ...
        private void btnContinuar_Click(object sender, EventArgs e)
        {
            ...
            var tipoIdentificacion = cboTidentificacion.SelectedItem as TipoIdentificacion;
        ...
        private void DatosPaciente_Load(object sender, EventArgs e)
        {
            ...
            cboTidentificacion.DataSource = negocio.ObtenerTiposIdentificacion();
            cboTidentificacion.DisplayMember = "Nombre";

            cboCiudadResidencia.DataSource = negocio.ObtenerCiudades();
            cboCiudadResidencia.DisplayMember = "Nombre";

            cboEstadoCivil.DataSource = negocio.ObtenerEstadoCivil();
            cboEstadoCivil.DisplayMember = "Nombre";

            cboOcupacion.DataSource = negocio.ObtenerOcupacion();
            cboOcupacion.DisplayMember = "Nombre";

            cboNEscolaridad.DataSource = negocio.ObtenerNivelEscolaridad();
            cboNEscolaridad.DisplayMember = "Nombre";

            cboEps.DataSource = negocio.ObtenerEPS();
